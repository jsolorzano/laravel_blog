                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('posts.store') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="title" class="form-control" type="text" name="title" value="{{ old('title') }}" placeholder="Write the title of the post" autocomplete="name" autofocus>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <textarea class="form-control" id="body" name="body" placeholder="Write your post here" required>{{ old('body') }}</textarea>
                            </div>
                        </div>
